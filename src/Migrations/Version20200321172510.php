 ...
 */
final class Version20200321172510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE correspondant_administratif (id INT AUTO_INCREMENT NOT NULL, responsable_legal_id INT DEFAULT NULL, num_secu VARCHAR(255) NOT NULL, aide_caf VARCHAR(255) NOT NULL, aide_msa VARCHAR(255) NOT NULL, aide_autres VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_E1E7152E46135043 (responsable_legal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
