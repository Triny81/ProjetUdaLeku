 ...
 */
final class Version20200317215812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE affaire (id INT AUTO_INCREMENT NOT NULL, type_affaire_id INT NOT NULL, nom_francais VARCHAR(40) NOT NULL, nom_basque VARCHAR(40) NOT NULL, INDEX IDX_9C3F18EFED813170 (type_affaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE correspondant_administratif (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, tel_dom VARCHAR(255) DEFAULT NULL, tel_port VARCHAR(255) NOT NULL, tel_trav VARCHAR(255) DEFAULT NULL, num_secu VARCHAR(255) NOT NULL, aide_caf VARCHAR(255) NOT NULL, aide_msa VARCHAR(255) NOT NULL, aide_autres VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
