 ...
 */
<<<<<<< HEAD:src/Migrations/Version20200503134118.php
final class Version20200503134118 extends AbstractMigration
=======
final class Version20200318161914 extends AbstractMigration
>>>>>>> e1e13eb645b79ada7517f9d2be860dc1655c42db:src/Migrations/Version20200318161914.php
{
...
=======
        ...
        $this->addSql('CREATE TABLE correspondant_administratif (id INT AUTO_INCREMENT NOT NULL, num_secu VARCHAR(255) NOT NULL, aide_caf VARCHAR(255) NOT NULL, aide_msa VARCHAR(255) NOT NULL, aide_autres VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
