 ...
 */
final class Version20200315204832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE correspondant_administratif ADD nom VARCHAR(70) NOT NULL, ADD prenom VARCHAR(50) NOT NULL, ADD email VARCHAR(255) NOT NULL, ADD tel_dom VARCHAR(10) DEFAULT NULL, ADD tel_port VARCHAR(10) NOT NULL, ADD tel_trav VARCHAR(10) DEFAULT NULL, CHANGE aide_caf aide_caf VARCHAR(30) DEFAULT NULL, CHANGE aide_msa aide_msa VARCHAR(30) DEFAULT NULL, CHANGE aide_autres aide_autres VARCHAR(40) DEFAULT NULL');
